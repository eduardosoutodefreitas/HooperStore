...
const ProductCard = ({ product }: ProductCard) => {
  ...
  return (
    <div className="min-w-[220px] h-[400px] max-w-[300px] flex flex-col flex-1 shadow-md">
      <div className="relative w-full h-4/5 rounded-sm">
        ...
        />
        <span className="p-1 px-2 rounded-3xl bg-primary text-white font-semibold text-xs absolute top-5 right-3">
          {product.tag}
        </span>
      </div>
